...
/**
 * Class dedicated to the creation of cache for the view and its transformation to concrete data.
 */
public class CacheInjectionViewServiceImpl implements CacheInjectionViewService {
	...
	/*
	 * (non-Javadoc)
	 * @see org.arqand.android.injection.api.CacheViewInjectionService#getValue(java .lang.Class)
	 */
	/**
	 * Gets the value.
	 * 
	...
	/*
	 * (non-Javadoc)
	 * @see org.arqand.android.injection.api.CacheViewInjectionService#getValue(org .arqand.android.injection.api.dto.ViewCacheDTO)
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.arqand.android.injection.api.CacheViewInjectionService#setValue(org .arqand.android.injection.api.ViewInjectionService)
	 */
