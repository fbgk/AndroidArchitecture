...
public class CacheFinalServiceImpl implements CacheFinalService {
	...
	/*
	 * (non-Javadoc)
	 * @see org.arqand.android.injection.cache.api.CacheFinalService#getCacheFinal (java.lang.Class, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.arqand.android.injection.cache.api.CacheFinalService#setCacheFinal (org.arqand.android.injection.api.dto.InformationCacheDTO)
	 */
	@SuppressWarnings("unchecked")
	@Override
